...
public class ElectricalFragment extends Fragment {
    ...
    private void initialize() {
        linearLayout = view.findViewById(R.id.linear_layout_electrical_dept);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvElectrical.setVisibility(View.GONE);
    ...
    private void getData() {
        firebaseFirestore.collection("post")
                .whereEqualTo("department", "Electrical")
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        if (String.valueOf(value.getDocuments().stream().count()).equals("0")) {
                            ...
                            tvElectrical.setVisibility(View.VISIBLE);
